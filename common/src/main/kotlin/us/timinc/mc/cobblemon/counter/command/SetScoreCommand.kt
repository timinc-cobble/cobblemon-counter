...
object SetScoreCommand : CounterCommand("set", PermissionLevel.ALL_COMMANDS) {
    override fun run(commandContext: Data, rawContext: CommandContext<CommandSourceStack>): Int {
        with(commandContext) {
            ...
            scoreType.setScore(manager, counterType, species.resourceIdentifier, form.name, score)
