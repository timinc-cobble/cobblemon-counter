...
class CounterManager(
     ...
     * species and form used to record if an alias exists in the form overrides offered by the data. A
    ...
    fun record(
        ...
        val formOverride = SpeciesFormOverride.Manager.findMatch(initialSpeciesId, initialFormName)
